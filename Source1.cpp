...
int main()
{
	...
	int dogAnimationIndecator = 0, throwSpeed = 0, catAnimationIndecator = 0;

	bool isDogTurn = true, canPlay = true, isPressing = false, game = true, play = true;

	//time
	Clock clock, deltaTimeClock, dogAnimationClock, catClock, catAnimationClock;

	//background
	Texture backgroundTexture;
	backgroundTexture.loadFromFile("C:/Users/Mohamed/Downloads/dc/background.png");
	Sprite background(backgroundTexture);
	background.setScale(0.9, 0.9);

	//wall
	Texture wallTexture;
	wallTexture.loadFromFile("C:/Users/Mohamed/Downloads/dc/wall.png");
	...
	//cat
	Texture catTexture;
	catTexture.loadFromFile("C:/Users/Mohamed/Downloads/dc/cat.png");
	...
	//dog
	Texture dogTexture;
	dogTexture.loadFromFile("C:/Users/Mohamed/Downloads/dc/dog.png");
	Sprite dog(dogTexture);
	dog.setPosition(1450, 600);
	...
	//bone
	Texture boneTexture;
	boneTexture.loadFromFile("C:/Users/Mohamed/Downloads/dc/bone.png");
	Sprite bone(boneTexture);
	bone.setPosition(1000, 500);
	bone.setScale(0.7, 0.7);

	//rubbish
	Texture rubbishTexture;
	rubbishTexture.loadFromFile("C:/Users/Mohamed/Downloads/dc/rubbish.png");
	...
	Texture tx;
	tx.loadFromFile("C:/Users/Mohamed/Downloads/dc/pause.png");
	pause.setTexture(&tx);
	...
	Texture tx2;
	tx2.loadFromFile("C:/Users/Mohamed/Downloads/dc/continue.png");
	...
	Texture tx3;
	tx3.loadFromFile("C:/Users/Mohamed/Downloads/dc/gameover.png");
	...
	Sound sound_cat;
	if (!soundBuffer_cat.loadFromFile("C:/Users/Mohamed/Downloads/dc/catpain.wav")) {
	...
	Sound sound_dog;
	if (!soundBuffer_dog.loadFromFile("C:/Users/Mohamed/Downloads/dc/dogpain.wav")) {
	...
	if (!soundBuffer_laughcat.loadFromFile("C:/Users/Mohamed/Downloads/dc/catlaugh.wav")) {
		cout << " i cant find cat2.wav " << endl;
	}
	...
	if (!soundBuffer_laughdog.loadFromFile("C:/Users/Mohamed/Downloads/dc/doglaugh.wav")) {
		cout << " i cant find dog2.wav " << endl;
	}
	...
	Sound sound_hit;
	if (!soundBuffer_hit.loadFromFile("C:/Users/Mohamed/Downloads/dc/hit.wav")) {
	...
	Sound sound_game;
	if (!soundBuffer_game.loadFromFile("C:/Users/Mohamed/Downloads/dc/gamesound.wav")) {
		...
		if (game && play) {
			...
			if (canPlay && !isDogTurn && throwSpeed == 0) {
				if (catClock.getElapsedTime().asSeconds() > 3.f) {
					time = (rand() % 5) + 1;
					catAnimationIndecator = 2;
					throwSpeed = calcuateThrowSpeedFromHoldingTime(time);
					catAnimationIndecator = 3;
				}
			}
			cat.setTextureRect(IntRect(texturesize.x * catAnimationIndecator, texturesize.y * 0, texturesize.x, texturesize.y));
